...
- This is a composite GitHub Action that embeds Python logic directly in
  action.yml.
- All changes to language detection logic should be made in the embedded Python
...
This repository provides a composite GitHub Action that detects programming
